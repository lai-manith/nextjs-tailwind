      ...
      <main className="px-10 bg-white md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between items-center">
            <h1 className="text-xl font-burtons">Developed By Manith</h1>
            <ul className="flex items-center gap-x-5">
              <li>
                <button className=" hover:bg-slate-300 p-2 text-xl rounded-md">
                  <BsFillMoonStarsFill />
                </button>
              </li>
              <li>
          ...
          <div className="text-center p-10">
            ...
            <p className="text-md leading-8 py-5 text-gray-800 md:text-xl max-w-lg mx-auto">
        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            {cardList.map((map, index) => (
              <div
                className="shadow-lg p-10 text-center rounded-xl my-10"
                key={index}
              >
                <Image
                  src={map}
        ...
        <section>
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            {[web1, web2, web3, web4, web5, web6].map((map, index) => (
              <div key={index} className="basis-1/3 flex-1 lg:basis-1/4">
                <Image
                  src={map}
                  placeholder="blur"
                  alt="web.png"
